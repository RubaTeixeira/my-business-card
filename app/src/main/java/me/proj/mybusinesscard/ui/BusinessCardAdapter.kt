...
import me.proj.mybusinesscard.data.BusinessCard
import me.proj.mybusinesscard.databinding.ItemBusinessCardBinding
...
class BusinessCardAdapter : ListAdapter<BusinessCard,BusinessCardAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(
        ...
        fun bind (item: BusinessCard) {
            ...
            binding.tvNomeDaEmpresa.text = item.empresa
